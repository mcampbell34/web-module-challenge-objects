...
console.log(createMenuItem(`taco`, 13, `Lunch`))
console.log(createMenuItem(`soup`, 13, `Lunch`))
console.log(createMenuItem(`smoothie`, 12, `any`))
...
console.log(addFeedback(`Marcus`, 5, ` "Awesomeness, I think I get this. But the trip was cool too`))
